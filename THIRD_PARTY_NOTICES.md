...
|---|---|---|
| Sandoval et al. 2025 | Citation and conceptual inspiration for power/precision teaching | Supplied article states CC BY-NC-ND; it reports GNU GPL for its software. Neither is incorporated or relicensed here. Verify the exact asset and version before any future reuse. |
| Lakens 2022 | Citation and goal/assumption framework | Independently written activity; no copied app or figure |
| DICE 2024 | Citation and extended investigation workflow | No supplemental code copied; reviewed limitations documented in the evidence note |
| Orsini et al. 2024 and Rudolph et al. 2021 | Citation and simulation teaching rationale | No article illustrations or datasets copied |
| Newcombe 1998 | Cited mathematical interval method | Independent R implementation; no publisher content or third-party code copied |
| R and Shiny | Runtime dependencies | Their own licences continue to apply; the MIT statement describes this repository's original code |
